    ...
    class Category {
        ...
        getPosts() {
            ...
            $.ajax({
                type: "POST",
                url: "/api_v1/categories",
                data: {'method': "getPost", "category": this.category},
                timeout: 600000,
                success: function (data) {
                    ...
                    if(response.length == 0)
                    {
                        ...
                        <div class="postCon">
                            <div class="titleCon">
                                <div class="titleTextCon" style="text-align: center;">
                                    <a class="titleText">There are no post available for this category</a>
                                </div>
                            </div>
                        </div>
                        `;
